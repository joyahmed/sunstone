#!/usr/bin/env node
// Adapted from the context-mode project (https://github.com/mksglu/context-mode), which writes this
// self-heal hook on install; redistributed here under that project's licence (Elastic License 2.0).
